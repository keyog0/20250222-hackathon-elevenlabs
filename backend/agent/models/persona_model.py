...
class PersonaModel(BaseModel):
    ...
    name: str
    core_traits: Dict[str, Any] = Field(description="Core personality traits that define the character")
    background: Dict[str, Any] = Field(description="Character's background information")
    speech_style: Dict[str, Any] = Field(description="Character's way of speaking and communication preferences")
    values: Dict[str, Any] = Field(description="Character's core values and beliefs")
    voice: Dict[str, Any] = Field(description="Character's voice settings")
